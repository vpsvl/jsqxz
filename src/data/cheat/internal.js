  ...
  list: [
    {
      ...
      initiative: [
        ...
        '【阴内专属】第一击必定触发，连击30%几率触发“九阴破体”无视目标20%防御',
        '【阴内专属】冰封系武功必出冰封',
        '【阴内专属】击中时50%几率，发动“飞絮劲”附加100点真实伤害，必命中',
        '【阴内专属】被攻击有(20+天书数*3)%几率，发动“九阴真气”提升650点气防（可叠加）',
      ],
      peculiar: [
        {
          name: '九阴神爪',
    ...
    },
    {
      ...
      peculiar: [{name: '梵我合一', condition: '神足经+瑜伽密乘，主运其中一个', effect: ['受到会暴击或连击的攻击时，20%几率终止敌方行动']}],
    },
    {
      id: 'niYunJingMai',
      name: '逆运经脉',
    ...
    },
    {
      ...
      sect: '',
      internal: '0',
      initiative: ['每5时序恢复1点内伤', '对冰封值超过80的人几率冻结', '拳法出招几率+20%', '免疫冰封', '攻击必冰封'],
    ...
    },
    {
      ...
      initiative: [
        ...
        '【阳内专属】每7时序自动解除自身封穴',
        '【阳内专属】使用灼烧系武功必出灼烧',
        '【阳内专属】被攻击有(20+天书数*3)%几率，发动“九阳真气”提升650点气防（可叠加）',
        '【阳内专属】每次行动前发动“九阳.抱元守一”清除自身不利状态',
        '【阳内专属】受到伤害>199时，高几率触发“氤氲紫气”：',
        '└气防增加600；',
        '└受到的气功减半；',
        '└承受伤害减少99；',
        '└承受气攻减少599；',
      ...
      peculiar: [
        {
          ...
          effect: ['破防目标30%', '金刚掌：必暴击', '般若掌：变为点攻，威力双倍', '十龙十象：主运龙象般若功，几率击晕目标'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      sect: '',
      internal: '1',
      initiative: ['每3时序恢复1点内伤', '被攻击时60%几率发动“金刚不坏”，高优先级降低30%所承受伤害及杀气'],
      peculiar: [
        {
          name: '少林绝学',
        ...
        },
        {
          ...
          effect: ['主运罗汉伏魔功、金刚不坏体或易筋神功，被攻击时30%几率第一击伤害降低50%'],
        },
      ],
    },
    {
      ...
      sect: '',
      internal: '1',
      initiative: ['拳掌武功招式几率+20%', '增加伤害10%，减伤10%'],
    ...
    },
    {
      ...
      sect: '',
      internal: '1',
      initiative: ['剑法武功招式几率+20%', '行动后几率触发“佛光普照”清除自身灼烧/中毒/冰封/流血/内伤'],
      peculiar: [{name: '一脉相承', condition: '', effect: ['可洗为九阳神功']}],
    },
    {
      ...
      sect: '',
      internal: '1',
      initiative: ['奇门武功招式几率+20%', '被攻击几率减伤20%并进入防御状态'],
      peculiar: [{name: '一脉相承', condition: '', effect: ['可洗为九阳神功']}],
    },
    {
      id: 'yiJinShenGong',
      ...
      initiative: [
        ...
        '免疫内伤',
        '少林武学威力+200',
        '被攻击时，40%几率触发“易筋真谛”完全免疫杀气和内伤',
        '使用大力金刚掌，40%几率触发“达摩掌”伤害+100',
        '使用罗汉掌，60%几率触发“般若掌”伤害+50',
        '被攻击有(20+天书数*3)%几率，发动“易筋真气”提升650点气防（可叠加）',
      ],
      peculiar: [
    ...
    },
    {
      ...
      initiative: [
        '每5时序恢复1点内伤',
        '封穴减少50%',
        '至人无己：攻击10%几率触发，目标集气倒走1~3时序',
        '神人无功：攻击30%几率触发，提升我方100点集气位置',
        '圣人无名：攻击50%几率触发，无视敌方80%的武常',
      ],
    ...
    },
    {
      ...
      initiative: [
        '每3时序恢复1点内伤',
        '攻击时50%几率发动“吸星大法”吸取敌方7%当前内力（上限300）与少量体力',
        '被攻击时50%几率发动“万物相吸.吸星大法”吸取敌方200点内力并转移到自身100点',
      ],
      peculiar: [
        {
          name: '万象天引',
    ...
    },
    {
      ...
      initiative: [
        ...
        '2书领悟：“水逝”增加冰封，冰封过50点几率发动“月映”冰冻5时序"',
        '3书领悟：“火延”增加燃烧，燃烧过50点几率发动“日明”点燃目标"',
        '4书领悟：“土掩”减伤30点，机率发动“风流”完全闪避攻击"',
        '5书领悟：“云翳”必杀集气200，20%（暴怒50%）几率“忘情无我”反弹全部伤害',
      ],
      peculiar: [],
    },
    {
      ...
      initiative: [
        ...
        '攻击时敌方产生怒气减半',
        '攻击时50%+(天书数*2+实战/25)%的几率发动“太玄之重”，攻击不会让敌方产生怒气',
        '└发动太玄之重时，若敌方为暴怒状态，则有50+(天书数*2+实战/25)%的几率发动：“救赵挥金锤.邯郸先震惊”，使敌方怒气值降低20点',
        '被攻击时，有40%的几率发动“太玄之轻”，免疫杀气，并将被杀气值转换成提升集气值，同时免疫内伤和普通中毒',
        '正线胜李白后，解锁“混沌太玄”：被攻击时，有30%几率将受到伤害的50%转化为回血',
        '邪线胜石破天后，解锁“太玄反震”：被攻击时，有50%几率对攻击方造成10点封穴（可叠加）',
      ],
      peculiar: [],
    },
    {
      ...
      initiative: [
        '斗转星移不需要主运即可生效',
        '高资(80-100)，斗转几率+10%，且斗转可控为高资专属',
        '爆怒时，如会斗转星移则几率增加20%',
        '【北斗移辰】：',
        '总兵器值<240，被攻击时25+(资质-30)/2几率触发',
        '以50%的威力斗转反击，并追加300点气攻',
        '【斗转星移】：',
        '240≤总兵器值<360，被攻击时25+(资质-30)/2几率触发',
        '以60%的威力斗转反击，并追加600点气攻',
        '【离合参商】：',
        '360≤总兵器值<520，被攻击时25+(资质-30)/2几率触发',
    ...
    },
    {
      ...
      initiative: [
        ...
        '免疫内伤',
        '复活时回复满血并立即行动',
        '顾道长生：被攻击25%几率触发，5时序内每时序恢复最大生命&内力1%',
    ...
    },
    {
      ...
      initiative: [
        '每5时序恢复1点内伤',
        '基础集气速度提升20%',
        '被攻击，30%几率触发“葵花移形”，降低30%的所受伤害和杀气',
        '被攻击，15%几率触发“真·葵花移形”，完全闪避一次攻击',
        '攻击时，50%几率触发“葵花诀·六合”：给敌增加1~2层减速BUFF",每层减敌集气2%，上限10层',
        '攻击时，20%几率触发“葵花刺目”：给敌方附加盲目DEBUFF，20%几率攻击MISS',
        '攻击时，60%几率触发“葵花点穴手”:增加气攻1000，必封穴',
    ...
    },
    {
      ...
      initiative: [
        '每3时序恢复1点内伤',
        '攻击时，50%几率吸取敌方7%当前内力（上限300）',
        '被攻击时，50%几率发动“北冥神功·百川入海”吸取敌方200点内力左右并转移到自身',
        '被攻击时，50%的几率触发“北冥真气”护体，+800气防（可叠加）',
        '攻击时(15+天书数量)%几率发动“北冥·气吞山河”吸取敌方20点怒气（限主角）',
      ],
      peculiar: [
        {
          name: '自在逍遥',
    ...
    },
    {
      ...
      initiative: [
        '每5时序恢复1点内伤',
        '被攻击时，20%几率触发护体气盾吸收33.3%所受伤害，并回复等量内力',
        '防御效果加成由25%提升至40%，且防御时的气防由500提升至1000',
        '免疫难5以上NPC根据伤害高低所追加的杀气及龙象的追加杀气',
        '被攻击时，10%几率触发护体气盾吸收33.3%所受的伤害，并回复等量内力',
    ...
    },
    {
      ...
      initiative: [
        ...
        '每3时序回复1点体力',
        '造成的封穴效果提高20%',
        '攻击时50%追加"混元一气"特效：对攻击目标追加5~15点内伤',
      ],
    ...
    },
    {
      ...
      initiative: [
        '每3时序恢复1点内伤',
        '攻击时，50%几率化去敌方5%当前内力（上限300，下限100），并强制上毒16~20点',
        '被攻击时，50%几率发动“化功大法”化去敌方200点内力，并强制上毒10~15点',
      ],
      peculiar: [],
    },
    {
    ...
    },
    {
      ...
      initiative: [
        '每3时序回复1点内伤',
        '连击时有(30+天书数*2)%的几率触发夭矫空碧特效，此次连击伤害、杀气不减',
        '人物攻击的第一击，有(天书数×2)%几率触发进趋如风特效，额外增加一次攻击（主角使用时几率增加5%，且暴怒时在每回合的第一次出手必发动）',
        '限女性，攻击与气攻增加20%',
        '受到的灼烧降低50%',
      ],
    ...
    },
    {
      ...
      internal: '',
      initiative: [
        '被攻击时5%几率将一半伤害转化为自身护盾',
        '被攻击时5%几率将一半伤害转化为对方掉血',
        '被攻击时5%几率将一半伤害转化为内力回复',
        '被攻击时5%几率攻击转给随机地方承受',
        '被攻击时5%几率转移自身位置',
        '被攻击时25%几率将杀气效果转由对方承受',
        '武功威力提升5%',
        '加力/护体/出招几率提升5%',
        '气攻/气防提升5%',
      ],
    ...
    },
    {
      ...
      initiative: [
        ...
        '回合开始自动防御',
        '蓄力状态下集气速度增加30%',
        '防御状态下无法被杀气，被攻击35%几率触发“伺机而动”集气位置+100',
        '防御状态下被攻击时反震目标内伤15点',
        '免疫破绽',
        '被攻击进入防御状态，初始几率25%，生命越低几率越高',
      ],
    ...
    },
    {
      ...
      internal: '',
      initiative: [
        '首次被击退时，100%发动“神照功起死回生”复活，之后有6%的几率发动',
    ...
    },
    {
      ...
      initiative: [
        ...
        '受攻击时几率触发“蛤蟆功.蓄力”，累计蓄力值（被一阳指攻击会降低蓄力值）',
    ...
    },
    {
      ...
      internal: '',
      initiative: [
        '内力高于对方时，被攻击50%几率触发“乾坤大挪移反弹”，反弹30%伤害',
