export default {
  ...
  list: [
    ...
    },
    {
      ...
      internal: '',
      sect: '',
      peculiar: [{name: '绝处逢生', condition: '海叟钓法+银锁金玲', effect: ['被攻击15%几率不受伤害']}],
    },
    {
      id: 'huYanQiangFa',
      name: '呼延枪法',
    ...
    },
    {
      ...
      sect: '',
      peculiar: [
        {name: '琴棋书画-书', condition: '同时修炼琴棋书画', effect: ['威力+300', '秉笔直书：攻击必定造成封穴，且伤害提升20%，几率发动']},
      ],
    },
    {
      id: 'jinGangFuMoQuan',
    ...
    },
    {
      ...
      sect: '',
      peculiar: [
        {name: '天下无狗', condition: '使用打狗棒法40%几率发动，暴怒必定发动', effect: ['攻击无误伤，攻击范围变为面攻，气攻提升至2400']},
        {
          name: '盖世无双',
