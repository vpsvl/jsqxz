export default {
  ...
  list: [
    ...
    },
    {
      ...
      sect: '',
      peculiar: [
        {name: '极意', condition: '攻击时有30%几率触发，暴怒必触发', effect: ['攻击变为面攻，追加1000气功并引爆目标身上毒素']},
        {
          name: '毒布武林',
    ...
    },
    {
      ...
      sect: '',
      peculiar: [
        {name: '', condition: '', effect: ['六脉神剑招式几率提升至60%']},
    ...
    },
    {
      ...
      sect: '',
      peculiar: [
        {name: '剑气碧烟横', condition: '使用六脉神剑攻击50%几率触发', effect: ['本次攻击敌方的指法系数按50%计算']},
        {
          name: '六脉玄机',
          condition: '25+(实战/20)几率触发以下一种特效，段思平必定触发',
          effect: [
            '剑逆天光：无视敌方气防 且必破防40%',
            '剑煌镜影：增加一次连击 附带灼烧效果',
