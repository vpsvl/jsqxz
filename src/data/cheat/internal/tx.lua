...
function NGTX_sm(ng,tx)
    ...
    ------------------------【恢复类】-------------------------------	
        if tx == 200 then 
            ...
            hh = sx[kfcj]
            --local gl = kfcj*25
            txwz = {'时序回怒','Ｗ每'..cl2..hh..cl..'时序回复'..cl2..(kfcj)..cl..'点怒气值。',3}
        end
        if tx == 201 then 
            local hh =  9-kfcj*5 
            hh = sx[kfcj]
    ...
    ------------------------【增益类】-------------------------------		
        ...
        if tx == 310 then 
            local hh =  kfcj*2 
            --local gl = kfcj*10
            txwz = {'避险','Ｗ增加七格内我方攻击时的闪避'..cl2..hh..'%',3}
        end
    ...
    ------------------------【受击类】特效----------------------------	
        if tx == 800 then 
            --local hh =  kfcj
            local gl = (kfcj*15)..'%'
            txwz = {'逆转阴阳','Ｗ受到伤害时将杀气的'..cl2..gl..'Ｗ转化为自身的集气。',4}
        end
        if tx == 801 then 
            --local hh =  kfcj
            local gl = ((kfcj+1)*6)..'%'
            txwz = {'混沌太玄','Ｗ受到伤害将受到的伤害的'..cl2..gl..'Ｗ转化为生命回复。',4}
        end
        if tx == 802 then 
            --local hh =  kfcj
            local gl = (kfcj*6)..'%'
        ...
        if tx == 813 then 
            local hh =  kfcj
            local gl = (kfcj*25)..'%'
            txwz = {'大宗师','Ｗ受到伤害时'..cl2..gl..'Ｗ概率'..cl2..hh..'Ｗ时序回复生命值2点、内力值4点。',3}
        end
        if tx == 814 then 
            --local hh =  kfcj*200
            local gl = (kfcj*15)..'%'
    ...
    ------------------------【攻击类】特效----------------------------	
        ...
        if tx == 908 then 
            local hh =  kfcj*200
            --local gl = (kfcj*25)..'%'
            txwz = {'刀法之力','Ｗ增加剑法武功的威力'..cl2..hh..'Ｗ。',4}
        end
        if tx == 909 then 
            local hh =  kfcj*200
            --local gl = (kfcj*25)..'%'
    ...
    ------------------------【特殊效果】------------------------------	
        ...
        if tx == 1039 then 
            local gl = (kfcj*25)..'%'
            txwz = {'暂无','Ｗ蓄力必成功，同时执行防御和等待指令，且蓄力效果增加到50%。'..cl2..gl..cl..'概率在行动自动执行蓄力。',4}
        end
        if tx == 1040 then 
            local hh = kfcj*10
            local gl = (kfcj*50)..'%'
