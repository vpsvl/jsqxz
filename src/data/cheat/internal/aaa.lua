...
function NGTX_sm(ng,tx)
    ...
    ------------------------【恢复类】-------------------------------
        if tx == 100  then
            txwz = {'回命','Ｗ每回合恢复'..cl2..(kfcj*100)..cl..'点生命值',1}
        end
        if tx == 101 then
            txwz = {'回命','Ｗ每回合恢复'..cl2..(kfcj*100)..cl..'点内力值。',1}
        end
        if tx == 102  then
            txwz = {'回体','Ｗ每回合恢复'..cl2..(kfcj*1)..cl..'点体力值。',1}
        end		
        if tx == 103  then
            txwz = {'回气','Ｗ每回合恢复'..cl2..(kfcj*1)..cl..'点气力。',1}
        end
        if tx == 104  then       
            txwz = {'命归','Ｗ每回合恢复最大生命值'..cl2..(kfcj*2)..'%'..cl..'点生命值。',3}
        end	
        if tx == 105  then
            txwz = {'气归','Ｗ每回合恢复最大内力值'..cl2..(kfcj*2)..'%'..cl..'点内力值。',3}
        end	
        if tx == 106  then
            local hh =  kfcj*5 
            hh = sx[kfcj]
            --local gl = kfcj*25
            txwz = {'时序回命','Ｗ每'..cl2..hh..cl..'时序恢复'..cl2..(kfcj*2)..cl..'点生命值。',3}
        end
        if tx == 107 then
            local hh =  9-kfcj*5 
            hh = sx[kfcj]
            --local gl = kfcj*25
            txwz = {'时序回内','Ｗ每'..cl2..hh..cl..'时序恢复'..cl2..(kfcj*2)..cl..'点内力值。',3}
        end 
        if tx == 108 then
            local hh =  9-kfcj*5 
            hh = sx[kfcj]
            --local gl = kfcj*25
            txwz = {'时序回体','Ｗ每'..cl2..hh..cl..'时序恢复1点体力值。',3}
        end 
        if tx == 109 then
            local hh =  9-kfcj*5 
            hh = sx[kfcj]
            local gl = (kfcj*5)..'%'
            txwz = {'回春','Ｗ每回合恢复损失生命值的'..cl2..gl..cl..'。',3}
        end 
        if tx == 110 then
            local hh =  9-kfcj*5 
            hh = sx[kfcj]
            local gl = (kfcj)..'%'
            txwz = {'气血相生Ⅰ','Ｗ当（生命/生命最大值）百分比如果大于（内力值/内力最大值）百分比，则'..cl2..hh..cl..'时序恢复'..cl2..gl..cl..'最大内力值。',4}
        end
        if tx == 111 then
            local hh =  9-kfcj*5 
            hh = sx[kfcj]
            local gl = (kfcj)..'%'
            txwz = {'气血相生Ⅱ','Ｗ当（生命/生命最大值）百分比如果小于（内力值/内力最大值）百分比，则'..cl2..hh..cl..'时序恢复'..cl2..gl..cl..'最大生命值。',4}
        end  
    ...
    ------------------------【恢复类】-------------------------------	
        if tx == 200 then 
            ...
            hh = sx[kfcj]
            --local gl = kfcj*25
            txwz = {'时序回怒','Ｗ每'..cl2..hh..cl..'时序恢复'..cl2..(kfcj)..cl..'点怒气值。',3}
        end
        if tx == 201 then 
            local hh =  9-kfcj*5 
            hh = sx[kfcj]
    ...
    ------------------------【DEBUF】效果----------------------------
        ...
        if tx == 518 then 
            local hh =  kfcj*4
            --local gl = (kfcj*25)..'%'
            txwz = {'强化封穴','Ｗ攻击追加内伤点数'..cl2..hh..'Ｗ点。',2}
        end
        if tx == 519 then 
            --local hh =  kfcj*4
            local gl = (kfcj*20)..'%'
        ...
        if tx == 520 then 
            --local hh =  kfcj*4
            local gl = (kfcj*20)..'%'
            txwz = {'肓目','Ｗ攻击时'..cl2..gl..'Ｗ概率造成目标肓目增加一回合。',4}
        end
        if tx == 521 then 
            local hh =  kfcj*2
            local gl = (kfcj*15)..'%'
    ...
    ------------------------【受击类】特效----------------------------	
        ...
        if tx == 801 then 
            --local hh =  kfcj
            local gl = ((kfcj+1)*6)..'%'
            txwz = {'混沌太玄','Ｗ受到伤害将受到的伤害的'..cl2..gl..'Ｗ转化为生命恢复。',4}
        end
        if tx == 802 then 
            --local hh =  kfcj
            local gl = (kfcj*6)..'%'
        ...
        if tx == 813 then 
            local hh =  kfcj
            local gl = (kfcj*25)..'%'
            txwz = {'大宗师','Ｗ受到伤害时'..cl2..gl..'Ｗ概率'..cl2..hh..'Ｗ时序恢复生命值2点、内力值4点。',3}
        end
        if tx == 814 then 
            --local hh =  kfcj*200
            local gl = (kfcj*15)..'%'
        ...
        if tx == 822 then 
            ...
            txwz = {'天机秘术','Ｗ死亡时必复活一次，受到攻击时'..cl2..gl..'Ｗ概率且触发天机秘术中的一种：*将伤害的反弹给敌方随机目标*挪移位置躲避伤害*闪避伤害*自身获得霸体状态一回合。'。',4}       
        end
        if tx == 823 then 
            local hh =  kfcj*50
            local gl = (kfcj*25)..'%'
    ...
    ------------------------【攻击类】特效----------------------------	
        if tx == 900 then 
            ...
            local gl = (kfcj*25)..'%'
            local gl1 = (kfcj*10)..'%'
            txwz = {'血魔','Ｗ攻击时造成伤害时'..cl2..gl..cl..'概率将伤害的'..cl2..gl1..cl..'Ｗ转化为恢复自身生命，最多恢复身最大生命值的10%。',3}
        end
        if tx == 901 then 
           -- local hh =  kfcj
            local gl = (kfcj*25)..'%'
            local gl1 = (kfcj*10)..'%'
            txwz = {'血魔之盾','Ｗ攻击时造成伤害时'..cl2..gl..cl..'概率将伤害的'..cl2..gl1..cl..'Ｗ转化为恢复自身生命，最多恢复身最大生命值的5%，溢出部分转化为护盾，每次行动前吸取七格内敌人的流血点数的生命值化为护盾，护盾不会超过自身生命的10%。',4}
        end
        if tx == 902 then 
            --local hh =  kfcj
        ...
        if tx == 933 then 
            local hh =  kfcj*500
            local gl = (kfcj*25)..'%'
            txwz = {'龙象之力','Ｗ攻击时'..cl2..gl..cl..'概率随自身怒气值增加伤害'..cl2..(kfcj*25)..cl..'%,并增加气攻'..cl2..hh..cl..'点。',4}
        end
        if tx == 934 then 
            --local hh =  kfcj*250
            local gl = (kfcj*20)..'%'
    ...
    ------------------------【特殊效果】------------------------------	
        ...
        if tx == 1004 then
            local hh =  kfcj*125
            local gl = 8-kfcj
            txwz = {'真气护盾','Ｗ进入战场获得'..cl2..hh..cl..'点护盾，每'..cl2..gl..cl..'回合重新获得护盾。',4}
        end
        if tx == 1005 then
            --local hh =  kfcj*125
            local gl = (kfcj*25)..'%'
            local gl1 = (kfcj*25)..'%'
            txwz = {'战场重生','Ｗ被击败时'..cl2..gl..cl..'概率重生，并恢复'..cl2..gl1..cl..'生命、内力和全部体力，清除所有DEBUFF。',4}
        end
        if tx == 1006 then
            local hh =  kfcj*125
            local gl = (kfcj*25)..'%'
            txwz = {'御气','Ｗ防御时'..cl2..gl..cl..'概率无法被杀气，且反震内伤'..cl2..hh..cl..'点内伤。',2}
        end
        if tx == 1007 then
            local hh =  kfcj
            local gl = (kfcj*25)..'%'
            txwz = {'蓄力强化','Ｗ蓄力时必成功，且增加蓄力'..cl2..hh..cl..'回合，蓄力后的攻击效果增加'..cl2..gl..cl..'。',4}
        end
        if tx == 1008 then
            --local hh =  kfcj
            local gl = (kfcj*25)..'%'
            txwz = {'灵犀分水','Ｗ受到攻击时'..cl2..gl..cl..'概率由全部参战人数一起分担'..cl2..gl..cl..'的伤害。',4}
        end
        if tx == 1009 then
            --local hh =  kfcj
            local gl = (kfcj*25)..'%'
            txwz = {'洞若观火','Ｗ受到连击或暴击攻击时'..cl2..gl..cl..'概率打断敌人攻击。',4}
        end
        if tx == 1010 then
            --local hh =  kfcj
            local gl1 = (kfcj*5)..'%'
            local gl = (100-kfcj*25)..'%'
            txwz = {'赤膊','Ｗ未装备防具时，防御+'..cl2..gl1..'。',3}
        end
        if tx == 1011 then
            local hh =  kfcj*2
            local gl = (kfcj*25)..'%'
            txwz = {'步战','Ｗ未装备坐骑时，集气+'..cl2..hh..'。',3}
        end
        if tx == 1012 then
            --local hh =  kfcj
            local gl1 = (kfcj*5)..'%'
            local gl = (100-kfcj*25)..'%'
            txwz = {'空手','Ｗ未装备武器时，攻击+'..cl2..gl1..cl..'。',3}
        end
        if tx == 1013 then
            local hh =  kfcj*100
            --local gl = (kfcj*25)..'%'
            txwz = {'先手','Ｗ战斗初始集气+'..cl2..hh..cl..'。',3}
        end
        if tx == 1014 then
            --local hh =  kfcj*100
            local gl = (kfcj*5)..'%'
            txwz = {'自强','Ｗ杀气被杀到-100，清除全部内伤，并恢复'..cl2..gl..cl..'生命。',3}
        end
        if tx == 1015 then
            --local hh =  kfcj*100
            local gl = (kfcj*15)..'%'
        ...
        if tx == 1016 then
            --local hh =  kfcj*100
            local gl = (kfcj*1)..'%'
            txwz = {'相济','Ｗ行动后消耗'..cl2..gl..cl..'内力恢复'..cl2..gl..cl..'生命。',3}
        end
        if tx == 1017 then
            --local hh =  kfcj*100
            local gl = (kfcj*1)..'%'
        ...
        if tx == 1021 then
            --local hh =  kfcj*100
            local gl = (kfcj*25)..'%'
            txwz = {'含沙','Ｗ攻击时'..cl2..gl..cl..'概率给目标附加一个DEBUFF。',3}
        end
        if tx == 1022 then 
            local hh =  5 - kfcj 
            local gl = kfcj*25
            txwz = {'佛光普渡','Ｗ每'..cl2..hh..'回合'..gl..'%'..cl..'概率清除流血、中毒、冰封、燃烧、内伤状态。'}
        end
        if tx == 1023 then 
            local hh =  5 - kfcj 
            local gl = kfcj*25
        ...
        if tx == 1027  then
            local hh = 6-kfcj
             local gl = (kfcj*5)..'%'
            txwz = {'普渡慈航','Ｗ每'..cl2..hh..cl..'回合恢复已经损失生命值、内力值、体力值的'..cl2..gl..cl..'。',4}
        end	
        if tx == 1028 then 
            --local hh =  kfcj*200
            local gl = (kfcj*8)..'%'
        ...
        if tx == 1030 then 
            --local hh =  kfcj*200
            local gl = (kfcj*25)..'%'
            txwz = {'自动防御','Ｗ行动后'..cl2..gl..cl..'Ｗ概率自动防御。',3}
        end
        if tx == 1031 then 
            --local hh =  kfcj*200
            local gl = ((6-kfcj)*50)..'%'
            local gl1 = (kfcj*25)..'%'
            txwz = {'以气化血','Ｗ受到伤害时以伤害值'..gl1..'内力抵消'..cl2..gl..'Ｗ的伤害。',4}
        end
        if tx == 1032 then 
            local hh =  6
            local gl = (kfcj*10)..'%'
        ...
        if tx == 1033 then 
            local hh =  kfcj
            local hh1 =  kfcj*100
            txwz = {'葵花百劫','Ｗ每次闪避和挪移自身集气集增加'..cl2..kfcj..cl..'点，集气位置增加'..cl2..hh1..cl..'，并给攻击方增加虚弱状态'..cl2..hh..cl..'回合，如果攻击方有肓目状态，则攻击方肓目状态增加1回合。',4}
        end
        if tx == 1034 then 
            local gl = (kfcj*10)..'%'
        ...
        if tx == 1035 then 
            local hh1 =  kfcj*100
            local gl = (kfcj*25)..'%'
            txwz = {'酒神之力','Ｗ行动前'..cl2..gl..cl..'获得即墨老酒/玉露酒/梨花酒/五宝花蜜酒之一效果，拥有任一酒效果时，伤害+20%，命中-10%，'..cl2..gl..cl..'击中敌方破绽。',4}
        end
        if tx == 1036 then 
            local gl1 =  (kfcj*20)..'%'
            local gl2 =  (kfcj*40)..'%'
        ...
        if tx == 1037 then 
            local gl = (kfcj*25)..'%'
            txwz = {'引毒虐焰','Ｗ敌方中毒大于100，攻击'..cl2..gl..cl..'概率引爆毒，造成中毒点数X5的真实伤害。',4}
        end
        if tx == 1038 then 
            local gl = (kfcj*25)..'%'
            txwz = {'蓄势待发','Ｗ蓄力必成功，同时执行防御和等待指令，且蓄力效果增加到50%。'..cl2..gl..cl..'概率在行动自动执行蓄力。',4}
        end
        if tx == 1039 then 
            local hh = kfcj*10
            local gl = (kfcj*5)..'%'
