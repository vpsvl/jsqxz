export default {
  ...
  list: [
    ...
    },
    {
      ...
      addition: '攻击+1 轻功+1 御剑+2',
      sect: '',
      peculiar: [{name: '素质三连', condition: '三分剑法+连城剑法', effect: ['全武功攻击时50%概率三连击，暴怒必三连']}],
    },
    {
      id: 'raoZhiRouJian',
      name: '绕指柔剑',
    ...
    },
    {
      ...
      addition: '攻击+1 御剑+3',
      sect: '',
      peculiar: [{name: '以柔克刚', condition: '太极剑法+柔云剑法', effect: ['被攻击时，有50%概率将被杀气量的一半转化为回血']}],
    },
    {
      id: 'jinSheJianFa',
      name: '金蛇剑法',
    ...
    },
    {
      ...
      addition: '攻击+1 御剑+3',
      sect: '',
      peculiar: [{name: '', condition: '', effect: ['攻击时50%概率给敌人添加虚弱状态，暴怒必触发']}],
    },
    {
      id: 'xuanNvJianFa',
      name: '玄女剑法',
    ...
    },
    {
      ...
      peculiar: [
        ...
        {name: '以柔克刚', condition: '太极剑法+柔云剑法', effect: ['被攻击时，有50%概率将被杀气量的一半转化为回血']},
      ],
    },
    {
      id: 'xuanTieJianFa',
