export default {
  ...
  list: [
    ...
    },
    {
      ...
      addition: '攻击+1 御剑+3',
      sect: '',
      peculiar: [{name: '以柔克刚', condition: '同时修炼太极剑法+柔云剑法到极', effect: ['被攻击时，有50%几率将被杀气量的一半转化为回血']}],
    },
    {
      id: 'jinSheJianFa',
      name: '金蛇剑法',
    ...
    },
    {
      ...
      addition: '攻击+1 御剑+3',
      sect: '',
      peculiar: [{name: '', condition: '', effect: ['攻击时50%几率给敌人添加虚弱状态，暴怒必触发']}],
    },
    {
      id: 'xuanNvJianFa',
      name: '玄女剑法',
    ...
    },
    {
      ...
      peculiar: [
        ...
        {name: '以柔克刚', condition: '同时修炼太极剑法+柔云剑法到极', effect: ['被攻击时，有50%几率将被杀气量的一半转化为回血']},
      ],
    },
    {
      id: 'xuanTieJianFa',
      ...
      peculiar: [
        ...
        {name: '重剑真传.浪如山涌剑如虹', condition: '暴怒', effect: ['暴怒触发大范围伤害']},
        {
          ...
          effect: ['重剑无锋.破尽天下：', '无视一切必定破气防，且追加1000气攻', '暴击几率为40+装备等级*10'],
        },
        {
          name: '剑魔再临',
          condition: '包里有【玄铁剑法】或【独孤九剑】，且主角御剑≥320时，华山后山对话独孤求败，战胜可选择习得九剑真传或剑魔再临',
          effect: ['剑法攻击时50%几率发动两种特效之一：', '天极剑渊：破防50%，', '破尽天下：无视气防，气攻+800'],
        },
      ],
    },
    {
