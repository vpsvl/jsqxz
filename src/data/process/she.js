export default {
  ...
  good: [
      ...
      event: [
        {
          ...
          reward: ['道德+2', '奇门五转[内功秘籍]', '兰花拂穴手[指法秘籍]'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      event: [
        {
          list: ['与柯镇恶对话触发剧情', 'VS 梅超风', '胜后获得【疯魔棍法】【妙手空空】'],
          reward: ['疯魔棍法[奇门秘籍]', '妙手空空[拳掌秘籍]'],
        },
      ],
    },
    {
  ...
  evil: [
    ...
    },
    {
      ...
      event: [
        {
          list: ['进入场景触发战斗：', 'VS 洪七公（可败）', '剧情后获得【瞬息千里】'],
      ...
      event: [
        {
          ...
          reward: ['道德-3', '蛤蟆功[内功秘籍]', '张旭率意帖[剧情道具]剧情后开宝箱获得'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      event: [
        ...
        {
          list: ['选择帮江南七怪', 'VS 梅超风', '胜后获得【疯魔棍法】【妙手空空】'],
          reward: ['道德+2', '汗血宝马[坐骑]', '疯魔棍法[奇门秘籍]', '妙手空空[拳掌秘籍]'],
        },
      ],
    },
    {
