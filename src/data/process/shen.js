export default {
  ...
  normal: [
    {
      ...
      event: [
        {
          list: ['与小龙女对话，选『是』小龙女加入', '*畅想杨过直接跳转下边的畅想杨过线'],
  ...
  good: [
    ...
    },
    {
      ...
      event: [
        {
          list: ['进入客栈触发剧情，剧情后郭襄随队行动', '*开启万兽山庄，可去获取天外陨铁用于修复倚天邪断剑断刀'],
          reward: [],
        },
      ],
    },
  ...
  evil: [
    ...
    },
    {
      ...
      event: [
        {
          list: ['进入客栈，触发剧情', '剧情后金轮法王出现，带走郭襄', '*开启万兽山庄，可去获取天外陨铁用于修复倚天邪断剑断刀'],
          reward: [],
        },
      ],
    },
  ...
  branch: [
    ...
    },
    {
      ...
      event: [
        {
          list: ['进入大厅触发剧情，剧情后被关起来', '调查房间里的兵器架，获得[君子剑]、[淑女剑]', '调查房间大门，触发剧情'],
          reward: ['君子剑[武器]', '淑女剑[武器]'],
        },
        {
          list: ['剧情后进入大厅，触发战斗：', 'VS公孙止+绝情谷众', '胜后获得【阴阳倒乱刃】'],
    ...
    },
    {
      ...
      event: [
        {
          list: ['进入山洞，触发战斗：', 'VS 大蛇', '对话神雕后神雕加入队伍', '拔起神雕旁边的剑获得【玄铁剑】', '阅读神雕旁边的墙壁获得【玄铁剑法】，第一格洗玄铁剑法，获得天赋剑魔再临'],
          reward: ['道德+2', '神雕[队友]加入', '玄铁剑[武器]', '玄铁剑法[剑法秘籍]'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      event: [
        {
          list: ['程英在队时，进入大厅剧情后触发战斗：', '1、VS 裘千尺+绝情谷众', '2、VS 公孙止', '剧情后小龙女定下十六年之约，杨过离去', '*此处小龙女会自动出战'],
          reward: ['道德+5'],
        },
      ],
    },
    ...
    },
    {
      ...
      event: [
        ...
        {
          list: ['来到谷底触发剧情，小龙女入队'],
          reward: ['玉女心经[内功秘籍]', '天罗地网[轻功秘籍]', '小龙女[队友]加入'],
        },
        {
          list: ['从断崖上来，触发剧情'],
          reward: [],
