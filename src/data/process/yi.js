    ...
    },
    {
      ...
      event: [
        ...
        },
        {
          ...
          reward: ['道德+5', '天王保命丹[丹药]*3', '龙爪手[指法秘籍]'],
        },
      ],
    },
    {
      ...
      event: [
        {
          ...
          reward: ['大力金刚指[指法秘籍]', '倚天屠龙功[奇门秘籍]', '张无忌奖励：', '第三格武功洗太极拳一', '第四格武功洗太极剑法一'],
        },
      ],
    },
    {
      ...
      event: [
        {
          list: [
            '剧情后 VS 一堆番僧',
            '解救各派掌门，获得：',
            '【七伤拳谱】【两仪剑谱】【反两仪刀法】【虎爪绝户手】',
            '如有学龙爪手变为必中',
            '最后一个房间开启剧情，然后从铁门处上到万安寺顶',
          ],
          reward: ['道德+5', '七伤拳谱[拳掌秘籍]', '两仪剑谱[剑法秘籍]', '反两仪刀法[刀法秘籍]', '虎爪绝户手[指法秘籍]'],
        },
        {
