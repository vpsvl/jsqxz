export default {
  ...
  normal: [
    ...
    },
    {
      ...
      event: [
        {
          list: ['必须在神秘少女搜刮后，否则送信后会无法对话神秘少女'],
          reward: [],
        },
        {
          list: [
            '畅想和特殊人物将介绍信送给各门派NPC可加入门派：',
            '1. 天机宫(西部)、丐帮(中原)、星宿派(西部)（杀死丁春秋后无法加入和学习武功），送给传功NPC',
            '2. 华山派(中原)、逍遥派(北部灵鹫宫)、天龙寺(西部大理)，需在剧情推进到看门弟子消失之前，送给看门弟子',
            '3. 武当派(中原)需在跟张三丰对话前送给张三丰',
            '4. 血刀门(西部)送给血刀老祖，血刀老祖在人物模型偏左一格的位置',
            '5. 少林派(中原)送给大雄宝殿的玄慈，因为跟获取降魔刀法冲突，只能获得【降魔刀法】，暂时无法加入',
            '6. 密宗(西部大轮寺)找不到送信NPC，暂时无法加入',
          ],
          reward: [],
        },
        {
          list: [
            '打开主角房间中的宝箱之前，将介绍信送给青城派(西部)余沧海获得【摧心掌】',
          ],
          reward: [],
        },
        {
          list: [
            '打开主角房间中的宝箱之前，将介绍信送给重阳宫(中原)丘处机获得【金雁功】',
          ],
          reward: [],
        },
        {
