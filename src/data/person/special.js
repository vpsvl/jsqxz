  ...
  list: [
    {
      ...
      name: '陆渐',
      talent: [
        {name: '金刚门人', effect: ['攻击时为自己添加一个100时序“金刚法相”增益BUFF：攻击机率触发大金刚神力，无视绝对气防+1000气攻']},
        {
          name: '三十二身相',
          effect: [
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '大唐双龙', effect: ['阳内攻击必灼伤，几率点燃', '无视内属修炼刀法']},
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '大唐双龙·冰', effect: ['免疫冰封，攻击必冰封']},
        {
          name: '九字真言',
          effect: [
            '行动前几率触发九字真言其中的一种或多种，随天书跟实战的增加而增加触发最大数量',
            '※临-「不动根本印」：减伤50点',
            '※兵-「大金刚轮印」：破防40%',
            '※斗-「外狮子印」：气攻提升800',
            '※者-「内狮子印」：气防提升800',
    ...
    },
    {
      ...
      name: '西门吹雪',
      talent: [
        {name: '剑道巅峰', effect: ['击败谢云流领悟“剑道巅峰·五方行尽”，几率再行动一次']},
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '九阴神爪', effect: ['九阴神爪极意必两连，40%几率三连，暴怒必三连']},
      ],
      fortune: [],
    },
    {
      ...
      talent: [
        ...
        {name: '一苇渡江', effect: ['一苇渡江轻功自动运功']},
        {
          name: '五蕴皆空',
          effect: [
            'BOSS状态时亦复如是：被攻击时几率触发，把受到的伤害完全反弹给对方（包括暗器伤害）',
            '受想行识：行动前几率触发，敌方会随机获得debuff',
          ],
        },
      ],
      fortune: [],
    },
    {
      ...
      name: '梁萧',
      talent: [
        {name: '谐之道', effect: ['自身不会有破绽，暴怒时发动必中破绽，击中敌方破绽高机率造成敌方5时序集气暂停']},
        {
          name: '西昆仑',
          effect: [
            '灵鳖步和十方步加强',
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '剑魔再临', effect: ['玄铁剑法攻击时50%几率发动两种特效之一：', '天极剑渊：破防50%', '破尽天下：无视气防，气攻+800']},
      ],
      fortune: [],
    },
    {
    ...
    },
    {
      ...
      name: '酒神',
      talent: [
        {name: '酒神迷踪', effect: ['被攻击时有30%几率发动“酒神迷踪步”闪避']},
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '傲寒六诀', effect: ['使用刀法时周身10格范围敌人冰封20点，几率触发傲寒六诀冻结10时序', '被敌人攻击几率冻结敌人']},
        {name: '入魔', effect: ['暴怒时有一定几率进入入魔状态，免疫封穴杀气，吸血20%（上限200），且必连击几率三连击。暴怒结束入魔结束。']},
      ],
      fortune: [],
    },
    {
      ...
      talent: [
        ...
        {name: '流云飞袖', effect: ['被攻击30%几率抵挡伤害，且进行反击，伤害为120%，不可与斗转同时触发']},
