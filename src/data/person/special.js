  ...
  list: [
    {
      ...
      talent: [
        {
          name: '金刚门人',
          effect: ['攻击时为自己添加一个100时序“金刚法相”增益BUFF：攻击机率触发大金刚神力，无视绝对气防+1000气攻'],
        },
        {
          name: '三十二身相',
          effect: [
            '攻击时或被攻击时机率触发持续100时序“一合相”：减伤15%',
            '“一合相”存在期间，会发动以下身相：',
            '[神鱼相]：攻击时机率追加一次连击，暴怒必连',
            '[白毫相] ：被攻击时机率只受到100点气攻',
            '[雀母相]：被攻击时机率减伤50点',
            '[大自在相]：被攻击时机率+200集气',
          ],
    ...
    },
    {
      ...
      talent: [
        ...
        {
          name: '傲世狂刀',
          effect: ['刀法威力+200，增加自身20%耍刀系数的攻击和防御'],
        },
      ],
      fortune: [],
    },
    ...
    },
    {
      ...
      talent: [
        {
          name: '剑道巅峰',
          effect: ['击败谢云流领悟“剑道巅峰·五方行尽”，几率再行动一次'],
        },
        {
          name: '破苍穹',
        ...
        {
          name: '剑神',
          effect: ['进战满集气位置+1000，每个剑法到极减伤3% 增伤3%'],
        },
      ],
      fortune: [],
    },
    {
      ...
      talent: [
        ...
        {
          name: '惊才绝艳',
          effect: ['特效触发几率+10点，被攻击集气不会少于300'],
        },
      ],
      fortune: [],
    },
      ...
      talent: [
        ...
        },
        {
          ...
          effect: [
            '九阴神功自动运功',
            '【易筋锻骨】”：免疫封穴，免疫暴击伤害',
            '【天之道】：攻击时几率触发“天之道”附加目标生命最大值5%的伤害',
            '【大道归藏】(畅想专属)：无视条件修炼武功，所有武功都可以到极',
          ],
        },
        {
          name: '九阴神爪',
          effect: ['九阴神爪极意必两连，40%几率三连，暴怒必三连'],
        },
      ],
      fortune: [],
    },
    {
      ...
      talent: [
        ...
        {
          name: '万佛朝宗',
          effect: ['拥有绝对气防', '每五回合攻击时触发万佛朝宗，造成目标当前生命值10%伤害，并减少内力20%'],
        },
        {
          name: '毗婆舍那',
          effect: [
    ...
    },
    {
      ...
      talent: [
        ...
        {
          name: '剑魔再临',
          effect: ['玄铁剑法攻击时50%概率发动两种特效之一：', '天极剑渊：破防50%', '破尽天下：无视气防，气攻+800'],
        },
      ],
      fortune: [],
    },
    ...
    },
    {
      ...
      talent: [
        ...
        {
          name: '傲寒六诀',
          effect: ['使用刀法时周身10格范围敌人冰封20点，几率触发傲寒六诀冻结10时序', '被敌人攻击几率冻结敌人'],
        },
        {
          name: '入魔',
          effect: ['暴怒时有一定概率进入入魔状态，免疫封穴杀气，吸血20%（上限200），且必连击概率三连击。暴怒结束入魔结束。'],
        },
      ],
      fortune: [],
    },
