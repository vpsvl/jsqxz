...
function SetPersonTF()
    CC.Weather = {}	
	CC.Weather[1] = {0,"下雨",294,"下雨天伤口难以愈合。移动减-1步，攻击力-5%，无法点燃，封穴效果减半，流血效果翻倍。"}	
	CC.Weather[2] = {0,"下雪",295,"下雪天行动缓慢。集气-3，轻功-5%，灼烧和点燃效果减半，冻结和冰冻效果翻倍。"}	
	CC.Weather[3] = {0,"大雾",296,"有雾天人物视野受限。命中-10%。防御-5%，流血交果减半，封穴效果加倍。"}
	CC.Weather[4] = {0,"晴朗",297,"晴天干燥异常，小心火烛。闪避-10%，冻结时序减半，冰封效果减半，灼烧和点燃效果翻倍。"}
	CC.WeatherCD = 0
	CC.weat = 0
	--时间
    CC.Daytime = 0
	...
	CC.PTFSM[9759] = {'混沌太玄','可使用太玄神功攻击，太玄神功耗内降低50%（与天赋外功效果叠加，降低75%内力消耗），被攻击时，有50%几率触发太玄反震，对攻击方造成10点封穴，有30%几率将受到的伤害转化为减半回血。 ',2,1,4}
	...
	CC.PTFSM[49] = {'逍遥掌门','有特色指令:生死符。擂鼓山剧情后，自带北冥真气护体，天山折梅手修炼到极，资质变为50。*【福缘际遇】擂鼓山支线剧情，洗第一、二格武功，灵鹫宫拿八荒时，第三格洗为八荒六合功。',2,1,4}
	...
	CC.PTFSM[3] = {'金面佛','攻击时高几率附带灼烧，每100点御剑系数增加苗家剑法攻击范围1格，攻击时概率给目标造成散功10时序。*【福缘际遇】雪山飞狐闯王宝藏剧情，可选择洗第二格武功及天赋轻功。 ',2,1,3} --苗人凤
	CC.PTFSM[2] = {'灵枢素问','医疗能力上限400，用毒能力上限500，攻击时即使杀死敌方，也不会中断连击 ',2,1,4} --程灵素
	CC.PTFSM[1] = {'雪山飞狐','集气速度提升8点，特色指令【飞狐】：无视障碍物移动，在战场上来去自如。*【福缘际遇】得到《雪山飞狐》后，找苗人凤可洗第二格武功 ',2,1,3} -- 胡斐
