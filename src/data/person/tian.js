export default {
  ...
  list: [
    ...
    },
    {
      ...
      name: '段誉',
      talent: [
        {name: '六脉真传', effect: ['使用六脉神剑时出绝招几率+20%', '六脉神剑耗内降低50%（与天赋外功效果叠加，降低75%内力消耗）']},
        {name: '磊落仁心', effect: ['内力上限9999']},
        {name: '六脉玄机', effect: ['使用六脉神剑几率触发四招绝招，几率随实战增加，每100实战增加5％几率']},
      ],
    ...
    },
    {
      ...
      name: '慕容复',
      talent: [
        {name: '姑苏慕容', effect: ['修炼斗转星移无需兵器值条件', '斗转星移触发几率+10%']},
        {name: '离合参商', effect: ['斗转星移发动几率100%', '斗转反击时，无视兵器值需求必定发动【离合参商】']},
      ],
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '御法绝尘', effect: ['在场时，敌方非必触发特效几率降低5%，我方几率提高5%']},
      ],
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '引蛊', effect: ['行动前50%几率使用蛊毒刺激自身，自身每时序损失1%最大血量，此状态下自身血量越低，伤害、集气越高']},
      ],
      fortune: [],
    },
    {
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '大轮密宗', effect: ['火焰刀法【大轮密宗.火焰刀】发动几率100%']},
      ],
      fortune: [],
    },
    {
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '无形气墙', effect: ['被攻击时几率触发不动如山，触发不动如山时，额外的伤害将转化为护盾']},
        {name: '放下屠刀', effect: ['攻击时30%的几率触发【放下屠刀】降低目标伤害30%，持续一回合，无法叠加']},
      ],
      fortune: [],
    },
    {id: 'suXingHe', name: '苏星河', talent: [{name: '聪辩先生', effect: ['命中率+20%']}], fortune: []},
    {
      ...
      talent: [
        ...
        {name: '折梅手', effect: ['面板上每多一个武功到极，天山折梅手威力+50']},
        {name: '北冥极渊', effect: ['主动攻击触发北冥神功吸内时，几率吸取生命值']},
      ],
      fortune: [],
    },
    {
    ...
    },
    {
      ...
      name: '段延庆',
      talent: [
        {name: '恶贯满盈', effect: ['加力/护体/出招几率大幅提高', '无法休息']},
    ...
    },
    {
      id: 'zhongLing',
      name: '钟灵',
      talent: [{name: '毓秀灵姝', effect: ['攻击时必定造成流血', '闪电貂攻击时几率偷窃敌方携带的物品并对其强制上毒50点']}],
      fortune: ['云岭洞找到闪电貂，第一格武功洗闪电貂', '天龙正线，无量山洞收段誉，第一格武功洗六脉神剑，天赋外功洗为六脉神剑'],
    },
    {
      id: 'kuRong',
      name: '枯荣',
      talent: [{name: '天龙禅师', effect: ['使用一阳指高几率连击', '灼烧恢复能力加倍（时序恢复2点灼烧）']}],
      fortune: [],
    },
    {
      id: 'xuanCi',
    ...
    {id: 'xueMuHua', name: '薛慕华', talent: [{name: '阎王敌', effect: ['医疗上限500点', '战斗中满血复活自己或者同伴一次']}], fortune: []},
    {
      ...
      talent: [
        ...
        {name: '天仙锁魂', effect: ['敌方每回合30%几率附加虚弱状态2回合']},
      ],
      ...
      talent: [
        {
          name: '婆娑双树',
          effect: [
            '被攻击几率吸收80%的伤害，附加在下回合攻击中，攻击时几率吸收伤害的80%为自身增加护盾',
