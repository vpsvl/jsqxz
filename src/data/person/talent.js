export default {
  ...
  38: {
    ...
    name: '石破天惊',
    effect: [
      '觉醒后太玄消耗减半', '学有罗汉伏魔功，攻击时必出【罗汉伏魔】特效且效果增强10%',
    ],
  ...
  55: {
    ...
    name: '大器晚成',
    effect: [
      '左右互搏发动概率固定为80%', '作为队友时，最后10级的升级属性提高',
    ],
    fortune: [
  ...
  69: {
    ...
    name: '北丐',
    effect: [
      '使用降龙十八掌，40%概率发动【降龙.极意】', '使用降龙十八掌攻击无误伤',
    ],
    fortune: ['射雕支线华山绝顶剧情后，第三格武功洗九阴神功，天赋内功洗为九阴神功，内力属性变为阴内'],
    level: 3,
    exclusive: 2,
  },
  70: {
  ...
  90: {
    ...
    name: '毓秀灵姝',
    effect: [
      '攻击时必定造成流血', '闪电貂攻击时概率偷窃敌方携带的物品，并对其强制上毒50点',
    ],
    fortune: [
      '找到闪电貂后可第一格武功洗闪电貂',
  ...
  161: {
    ...
    name: '赤练仙子',
    effect: [
      '五毒神掌变为赤练神掌，追加70点伤害，并强制上毒20点，引爆目标身上毒素',
    ],
  ...
  566: {
    ...
    name: '白衣书生',
    effect: [
      '萧中慧在场，攻防提各提升100', '夫妻刀法威力增加300,闪避+300',
    ],
  ...
  633: {
    ...
    name: '辽东大侠',
    effect: [
      '天赋轻功自运', '自身免疫冰封', '装备冷月宝刀后胡家刀法威力+300，攻击必冰封',
    ],
  ...
  649: {
    ...
    name: '华山玉女',
    effect: [
      '紫霞神功必发动紫霞剑气', '剑法攻击必触发“玉女十九剑”增加自身连击率，暴怒必连',
    ],
  ...
  721: {
    ...
    name: '酒神',
    effect: [
      '初始暗器200，暗器必定1倍伤害', '喝酒buff有特殊攻击特效', '休息时必定蓄力防御',
    ],
    fortune: [
  ...
  9737: {
    id: 9737,
    name: '金刚伏魔',
    effect: ['造成伤害的恢复队友或自己生命，额外追加200点伤害'],
    fortune: [],
    level: 4,
    exclusive: 1,
  },
  ...
  9787: {
    ...
    name: '重阳再现',
    effect: [
      '战斗中首次被击退可复活一次,恢复70%生命值，部分状态，并立即行动，复活后，集气速度+5',
    ],
    fortune: [],
    level: 3,
    exclusive: 1,
  ...
  9893: {
    id: 9893,
    name: '六脉玄机',
    effect: ['使用六脉神剑触发四招绝招，概率随实战的增加，每100实战增加5%'],
    fortune: [],
    level: 3,
    exclusive: 2,
  },
  ...
  9914: {
    id: 9914,
    name: '韦陀双鹤',
    effect: ['使用韦陀掌概率触发“鹤啸九天”：', '周身六格内目标概率混乱，被攻击的目标集气位置倒退300'],
    fortune: [],
    level: 3,
    exclusive: 1,
  },
