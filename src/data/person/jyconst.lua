...
function SetGlobalConst()
   ...
   -- CC.窗口高度=lib.GetScreenH();
	...
	--动态显示的内容
	CC.RUNSTR={
				'快捷键 C-图签攻略 Z游戏信息 M-地图 F1-读档 F2-存档 F3-队列 F4-整理物品 H-回家',
   ...
   CC.PersonSize=1278;   --每个人物数据占用字节
	...
	for i = 1,6 do
		CC.Person_S["手少阴"..i]={286+2*(i-1),0,2};
	end	
	for i = 1,6 do
		CC.Person_S["手太阴"..i]={298+2*(i-1),0,2};
	end	
	for i = 1,6 do
	...
	for i = 11,20 do
		CC.Person_S["奇门奇穴等级"..i]={454+2*(i-1),0,2};
	end		
	for i = 1,17 do
...
CC.NG2 = {190,203,100,97,160,103,144,101,104,105,233,144}	--标记修改
	...
	CC.ZTSM[16] = {"皆","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","皆"}
	CC.ZTSM[17] = {"前","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","前"}
	CC.ZTSM[18] = {"在","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","在"}
	CC.ZTSM[19] = {"阵","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","阵"}
	CC.ZTSM[20] = {"列","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","列"}
	CC.ZTSM[21] = {"者","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","者"}
	CC.ZTSM[22] = {"斗","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","斗"}
	CC.ZTSM[23] = {"兵","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","兵"}
	CC.ZTSM[24] = {"临","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","临"}
	CC.ZTSM[25] = {"西瓜刀·天人","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","天人"}
	CC.ZTSM[26] = {"西瓜刀·残刀","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","残刀"}
	CC.ZTSM[26] = {"西瓜刀","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","残刀"}
	...
	CC.ZTSM[34] = {"曲风状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","曲风"}
	CC.ZTSM[35] = {"无名业火","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","业火"}
	CC.ZTSM[36] = {"同归状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","同归"}
	CC.ZTSM[37] = {"走火入魔","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","走火"}
	CC.ZTSM[38] = {"十龙十象","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","龙象"}
	CC.ZTSM[39] = {"昏迷状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","昏迷"}
	CC.ZTSM[40] = {"太极蓄力","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","蓄力"}
	CC.ZTSM[41] = {"蛤蟆蓄力","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","蓄力"}
	CC.ZTSM[42] = {"鲸息蓄力","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","蓄力"}
	CC.ZTSM[43] = {"金刚护盾","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","护盾"}
	CC.ZTSM[44] = {"神足护盾","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","护盾"}
	CC.ZTSM[45] = {"禁药状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","禁药"}
	CC.ZTSM[46] = {"沉睡状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","沉睡"}
	CC.ZTSM[47] = {"玉石俱焚","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","俱焚"}
	CC.ZTSM[48] = {"混乱状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","混乱"}
	CC.ZTSM[49] = {"散功状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","散功"}
	CC.ZTSM[50] = {"雷音状态","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","雷音"}
	CC.ZTSM[51] = {"参合状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","参合"}
	CC.ZTSM[52] = {"号令三军","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","号令"}
	CC.ZTSM[53] = {"偷天换日","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","偷天"}
	CC.ZTSM[54] = {"长生回天","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","回天"}
	CC.ZTSM[55] = {"虚弱状态","攻击力减少25%。",2,"CD:","回合","虚弱"}
	CC.ZTSM[56] = {"放下屠刀","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","屠刀"}
	CC.ZTSM[57] = {"金刚咒","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","金刚咒"}
	CC.ZTSM[58] = {"度化状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","度化"}
	CC.ZTSM[59] = {"魅惑状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","魅惑"}
	CC.ZTSM[60] = {"倾国倾城","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","倾国"}
	CC.ZTSM[61] = {"三十二身像","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","身像"}
	CC.ZTSM[62] = {"金刚法相","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","法相"}
	CC.ZTSM[63] = {"小李飞刀","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","飞刀"}
	CC.ZTSM[64] = {"天剑","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","天剑"}
	CC.ZTSM[65] = {"十八盘","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","十八盘"}
	CC.ZTSM[66] = {"万毒蚀体CD","时序让五格内的目标中毒。",1,"CD:","回合","蚀体CD"} 
	CC.ZTSM[67] = {"长生诀","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","长生"}
	CC.ZTSM[68] = {"麻痹状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","麻痹"}
	CC.ZTSM[69] = {"锁足状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","锁足"}
	CC.ZTSM[70] = {"迟缓状态","伤害减少20~50%，气攻减少20~50%。",2,"CD:","回合","迟缓"}
	CC.ZTSM[71] = {"疾风劲","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","疾风"}
	CC.ZTSM[72] = {"霸体","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","霸体"}
	CC.ZTSM[73] = {"逍遥御风闪避","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","御风"}
	CC.ZTSM[74] = {"中庸","立即行动。",1,"CD:","回合","中庸"}
	CC.ZTSM[75] = {"盲目状态","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","盲目"}
	CC.ZTSM[76] = {"刺目","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","刺目"}
	CC.ZTSM[77] = {"杀破狼","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","杀破狼"}
	CC.ZTSM[78] = {"杀破狼计时","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","杀破狼"}
	CC.ZTSM[79] = {"内伤状态","内伤。",1,"CD:","回合","内伤"}
	CC.ZTSM[80] = {"流血","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","流血"}
	CC.ZTSM[81] = {"封穴","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","封穴"}
	CC.ZTSM[82] = {"冰封","伤害减少20~50%，气攻减少20~50%。",1,"CD:","回合","冰封"}
	CC.ZTSM[83] = {"灼烧","受到伤害时，追加灼烧值的伤害，灼烧值大于25追加伤害翻倍。",1,"CD:","回合","灼烧"}
	CC.ZTSM[84] = {"点燃","时序减少生命。",1,"CD:","回合","点燃"}
	CC.ZTSM[85] = {"护盾值","可以抵消伤害。",1,"CD:","回合","护盾"} 
	CC.ZTSM[86] = {"中毒","时序减少生命值和内力值，减少属性。",1,"CD:","回合","中毒"}
	CC.ZTSM[87] = {"剧毒","每回合损失中毒程度X2倍的生命。",1,"CD:","回合","剧毒"}
	...
	CC.ZTSM[91] = {"卸甲状态","不计算当前额外附加的防御。",1,"CD:","回合","卸甲"}
	...
	CC.ZTSM[103] = {"冻结","冻结目标，停止集气。",1,"CD:","回合","冻结"}
	...
	CC.ZTSM[116] = {"紊乱状态","集气不受控制前后跳跃。",1,"CD:","回合","紊乱"}
	...
	CC.TSJM_SSYANG = {}
		...
		CC.TSJM_SSYANG[9] = {'至阳之体','防御+10%；【九阳护体】主运内功九阳神功后50%概率减伤30%，吸收20%受到的伤害化为护盾，每次行动后增加一个防御值的护盾。',61,'阳内且（天赋内功）九阳神功'}
