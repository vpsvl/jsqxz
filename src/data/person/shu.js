export default {
  ...
  list: [
    ...
    },
    {
      ...
      name: '陈家洛',
      talent: [
        {name: '天池红花', effect: ['攻击时有30%几率直接击中破绽，20%几率击中敌人后减少对方一格气力']},
        {name: '庖丁解牛', effect: ['攻击时有50%几率无视敌方30%防御']},
      ],
      fortune: [],
    },
    {
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '连环迷踪腿', effect: ['行动后50%几率使用“连环迷踪腿”攻击周身三格敌人，造成100点伤害']},
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '绵里针', effect: ['被攻击时20%几率通关四两拨千斤化解，并用暗器反击敌人']},
      ],
      fortune: [],
    },
    {
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '天池怪侠', effect: ['被攻击几率转移杀气值给攻击者', '百花错拳威力+600']},
