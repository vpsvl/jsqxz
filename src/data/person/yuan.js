  ...
  list: [
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '白驹过隙', effect: ['15%几率闪避攻击并反击，生命越低，闪避率越高，最高35%闪避率']},
      ],
    ...
    },
    {
      ...
      talent: [
        ...
        {name: '仁者无敌', effect: ['特效几率二次判定', '道德高于100时，免疫暴击、连击伤害']},
      ],
      fortune: ['笑傲邪击败葵花尊者天内洗葵花神功'],
    },
    {
      id: 'renFeiYan',
      name: '任飞燕',
    ...
    },
    {
      ...
      name: '卓天雄',
      talent: [
        {name: '铁掌神鞭', effect: ['震天铁掌威力翻倍，呼延鞭法威力三倍', '使用震天铁掌10%几率击晕目标', '使用呼延鞭法大概率造成封穴']},
      ],
      fortune: [],
    },
    {
