        ...
        },
        {
          ...
          list: [
            ...
            },
            {
              ...
              effect: ['防御+10%', '主运九阳神功时50%概率减伤30%，吸收受到伤害的20%转化为护盾，每次行动后增加一个防御值50%的护盾'],
            },
          ],
        },
      ],
      ...
      list: [
        {
          ...
          list: [
            ...
            },
            {
              ...
              effect: ['背包里的可以装备的所有奇门兵器都计算装备状态，增加的属性值只有一半（实际是计算的所有奇门兵器）'],
            },
            {
              name: '奇门无双',
      ...
      list: [
        ...
        },
        {
          ...
          list: [
            {
              name: '祝由',
              condition: '罗汉伏魔攻/混元功/枯荣禅功10级以上，100武学点数',
        ...
        },
        {
          ...
          list: [
            {
              name: '炼气',
              condition: '太虚剑意/忘情天书/小无相功10级以上，100武学点数',
