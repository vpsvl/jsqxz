      ...
      list: [
        {
          ...
          list: [
            ...
            },
            {
              ...
              effect: ['指法攻击必破气防，受到攻击必格挡', '[彩凤鸣岐]20%固定概率忽略目标此次伤害'],
            },
          ],
        },
        {
          ...
          list: [
            ...
            },
            {
              ...
              effect: [
                '主运五岳剑诀每2点御剑能力增加1点伤害，触发以剑御气减少(御剑能力/1000)%的伤害',
              ],
            },
            {
              name: '一剑镇神州',
          ...
          list: [
            {
              ...
              effect: ['奇门武功无视目标防御40%，依奇门兵器武功数量概率无视目标防御100%'],
            },
            {
              name: '兵器谱',
          ...
          list: [
            ...
            },
            {
              ...
              effect: [
                ...
                '运行高阶或绝学阴性内功时受到致命伤害时，触发【玄冰结界】使自己冰冻，并时序恢复生命到30%，期间免疫任何伤害',
              ],
            },
            {
              name: '至阴之体',
        ...
        },
        {
          ...
          list: [
            ...
            },
            {
              ...
              effect: [
                '集气速度+5，闪避+20%，命中+20%',
                '太玄神功主运特效【玄之太一】【混沌太玄】【太玄反震】增加固定触发概率10%',
              ],
            },
          ],
        },
      ...
      list: [
        ...
        },
        {
          ...
          list: [
            {
              name: '祝由',
              condition: '罗汉伏魔功/枯荣禅功/小无相功10级以上，100武学点数',
        ...
        },
        {
          ...
          list: [
            {
              name: '炼气',
              condition: '易筋神功/长生诀/忘情天书/葵花神功/阴阳无极功10级以上，100武学点数',
              effect: ['气防+10%，气攻+10%，10%概率免疫杀气'],
            },
            {
              name: '步亦趋',
              condition: '内力最大值≥5000，150武学点数',
            ...
            {
              name: '天人合一',
              condition: '天赋内功为易筋神功/阴阳无极功，200武学点数',
              effect: [
                '内力最大值+500',
      ...
      list: [
        {
          ...
          list: [
            {
              name: '乾坤',
              condition: '混元功/北冥神功/大周天功/乾坤大挪移10级以上，100武学点数',
              effect: ['学会北冥神功不需运功即可被动挨打吸内', '乾坤大挪移反弹伤害翻倍'],
            },
            {
              name: '逍遥游',
              condition: '内力最大值≥5000，150武学点数',
        ...
        },
        {
          ...
          list: [
            {
              name: '观星',
              condition: '奇门五转/吸星大法/化功大法/太极神功10级以上，100武学点数',
              effect: [
                '奇门五转特效概率+5%',
                '学会吸星大法/化功大法不需运功即可被打挨打吸内、吸体/化内',
              ],
            },
            {
              name: '太极图',
            ...
            {
              name: '物转星移',
              condition: '学会斗转星移秘技，200武学点数',
              effect: ['攻击+5%，防御+5%，全抗性+20%', '斗转伤害+20%', '武功消耗内力和真气降低50%'],
            },
          ],
        },
      ],
