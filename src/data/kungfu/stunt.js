...
const aa = {
  ...
  11: {
    ...
    condition: '五虎断门刀+五虎棍法',
    effect: [
      '赞天虎身轻如燕：一虎在场，攻击时30%概率提升全队100集气',
      '彻地虎是条好汉：二虎在场，被攻击时30%概率提高1000点气防',
      '穿山虎铁臂神拳：三虎在场，攻击时30%概率增加100点伤害',
      '翻江虎身手不凡：四虎在场，集气条30%概率跳跃10点集气速度',
      '锦毛虎一身是胆：五虎在场，被攻击时30%概率反弹10%伤害',
    ],
  },
  12: {
    id: 12,
  ...
  29: {
    ...
    name: '子午针灸',
    condition: '修炼子午针灸经',
    effect: ['对已方目标使用刺激目标，使目标拥有一回合的六层【激昂】状态'],
  },
  30: {
    id: 30,
    name: '千金术',
    condition: '修炼千金方',
    effect: ['清除范围内乙方的基础异常状态，并回复少量气血'],
  },
  31: {
    id: 31,
    name: '药王神篇',
    condition: '修炼药王神篇',
    effect: ['治疗已方单体目标，回复大量气血'],
  },
  32: {
    id: 32,
    name: '黄帝内经',
    condition: '修炼黄帝内经',
    effect: ['治疗已方单体目标，并持续回复气血'],
  },
  33: {
    id: 33,
    name: '毒经',
  ...
  34: {
    ...
    name: '蛊术',
    condition: '',
    effect: ['对目标施加盅术，概率命中，命中后盅虫会在一回合后发作，造成目标大量伤害'],
  },
  35: {
    id: 35,
    name: '华陀医术',
    condition: '修炼华佗内昭图',
    effect: ['使用药品和医疗时，效果额外增加20%'],
  },
  36: {
    id: 36,
    name: '天衣无缝',
