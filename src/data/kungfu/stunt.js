...
export default {
  ...
  zhongYongZhiDaoEr: {
    ...
    name: '中庸之道贰',
    condition: '修炼中庸之道，资质31~79',
    effect: ['仅中资(31-79)可触发', '受到攻击后如果满怒，(资质-29)%概率结束对手攻击并反击'],
    type: 1,
  },
  douZhuanXingYi: {
    id: 3,
    ...
    effect: [
      '仅高资(80-100)可触发',
      '被攻击时20+(资质-30)/2概率触发反击，并追加气攻',
      '高资(80-100)斗转可控',
      '爆怒时斗转概率+20%',
      '触发斗转星移时，根据总兵器值发动以下效果：',
      '北斗移辰：总兵器值<240时发动',
      '北斗移辰：以60%的威力斗转反击，并追加300点气攻',
      '斗转星移：240≤总兵器值<360时发动',
      '斗转星移：以85%的威力斗转反击，并追加600点气攻',
      '离合参商：360≤总兵器值<520时发动',
      '离合参商：以110%的威力斗转反击，并追加1200点气攻',
      // '幻梦星辰：总兵器值≥520时，(总兵器值之和-520)%概率(上限50%)发动幻梦星辰反击，否则发动离合参商反击',
      // '幻梦星辰：反击伤害和气攻提高到115%，且反击范围为全屏锁定攻击',
      '特别说明: 总兵器值=总系数之和-周目数×5',
    ],
    type: 1,
  },
  zuoYouHuBo: {
  ...
  ciBeiWeiHuai: {
    ...
    effect: ['道德高于60时，减伤(7-境界等级)×(150-资质)点'],
    type: 1,
  },
  tieJia: {
    id: 10,
  ...
  senLuoWanXiang: {
    ...
    effect: [
      ...
      '根据击杀数和怒气值(每50点怒气增加1次，暴怒额外增加2次)增加伤害次数（威力等于750+实战数值）',
    ],
    type: 1,
  },
  xieZhanShaChang: {
    ...
    effect: [
      '使用岳家枪法/岳王散手对7×7范围内敌人造成10~20点伤害1次',
      '根据击杀数和怒气值（每50点怒气增加1次，暴怒额外增加2次）增加次数（威力等于750+实战数值）',
  ...
  juHuoLiaoYuan: {
    ...
    effect: [
      '金乌刀法/燃木刀法/火焰刀法攻击时有50%概率、暴怒攻击必定触发，追加10时序的“引燃”状态',
      '引燃：每时序损失2%当前血量',
    ],
    type: 1,
  },
  ...
  chuQueSiXiang: {
    ...
    effect: [
      '被攻击时概率触发（可同时触发）：',
      '└无我相：50%概率免疫本次攻击造成的内伤、封穴、冰封和灼烧，并反弹20%造成伤害',
      '└无人相：50%概率使敌人转变攻击目标',
      '└无寿者相：50%概率立即恢复5%生命，并免疫下一次致死伤害',
      '└无众生相：50%概率免疫本次攻击的杀气,集气条立即前进100点',
  ...
  fanWoHeYi: {
    ...
    name: '梵我合一',
    condition: '神足经+瑜伽密乘',
    effect: ['受到会暴击或连击的攻击时，15%概率终止敌方行动'],
    type: 2,
  },
  yiJinDuanGu: {
    id: 45,
  ...
  kaiTaiJi: {
    ...
    effect: [
      '【太极奥义】的概率100%',
      '主运太极神功，使用太极拳法或太极剑法，蓄力值超过500且怒气值>=50时，消耗50点怒气值，根据当前生命值跟内力值追加大范围伤害，生命越低/内力越高伤害越高',
    ],
    type: 1,
  },
  fengHuoLianCheng: {
