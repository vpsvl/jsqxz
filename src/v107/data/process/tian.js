      ...
      event: [
        {
          list: [
            ...
            '1、主角+乔峰 VS 游氏双雄',
            '2、主角+乔峰 VS 游氏双雄+薛慕华',
            '3、主角+乔峰 VS 游氏双雄+薛慕华+丐帮弟子',
            '4、主角+乔峰 VS 游氏双雄+薛慕华+各派弟子',
            '5、主角+乔峰 VS 游氏双雄+薛慕华+各派弟子',
          ],
          reward: ['道德+5'],
        },
        {
          list: [
            '五连战后主角被乔峰打出聚贤庄，再次进入聚贤庄与阿朱对话',
            '若身上有[七宝指环]可收薛慕华入队',
          ],
          reward: [],
        },
      ...
      event: [
        ...
        },
        {
          list: [
            ...
            '2、主角 VS 慕容复',
            '3、主角+乔峰 VS 游坦之+慕容复',
            '4、主角+乔峰 VS 游坦之+慕容复+鸠摩智，得【无相劫指法】',
  ...
  evil: [
      ...
      event: [
        {
          list: [
            ...
            '获得【斗转星移】',
            '*邪线开启后将不可收虚竹入队，虚竹支线会中断，需要天山六阳掌、小无相功、七宝指环的要提前去做完虚竹支线',
      ...
      event: [
        {
          list: [
            ...
            '1、主角+游坦之 VS 乔峰',
            '2、主角+游坦之+慕容复+王语嫣 VS 乔峰+段誉',
            '3、主角+游坦之+慕容复+王语嫣+鸠摩智 VS 乔峰+段誉+虚竹+萧远山',
    ...
    },
    {
      ...
      event: [
        {
          list: [
            '少林寺大战后，慕容复在队，去左下角还施水阁最左边从下数第二排书架的右边调查可获得【参合指法】【参合剑气】',
    ...
    },
    {
      ...
      event: [
        {
          list: [
            '进入天龙寺慕容复（需领悟黑级浮屠）在队，触发剧情，慕容复是队友则战前经脉全通',
            '主角+慕容复 VS 乔峰+段誉+虚竹+天龙寺众僧',
  ...
  branch: [
    ...
    },
    {
      ...
      event: [
        {
          list: [
            '从凉州进入西夏皇宫，进入左侧房间触发战斗：',
            '主角+虚竹 VS 李秋水（坚持300时序即可）',
          ],
          reward: [],
        },
        {
          list: ['进入西夏皇宫右上角房间对话李清露，收李清露入队', '获得【寒袖拂穴】【白虹掌力】'],
          reward: ['李清露[队友]加入', '寒袖拂穴[指法秘籍]', '白虹掌力[拳掌秘籍]'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      event: [
        ...
        {
          list: ['与扫地僧对话，扫地左边书架调查触发战斗', '主角 VS 扫地僧'],
          reward: ['一苇渡江[轻功秘籍]'],
        },
        {
          list: [
            '拿到一苇渡江后，扫地僧右边书架调查获得【易筋经】',
            '可选择挑战达摩，主角 VS 达摩，战胜达摩后可激活易筋神功特效【天地失色】',
          ],
          reward: ['易筋经[内功秘籍]'],
        },
      ],
