...
const secret = {
  ...
  46: {
    ...
    effect: [
      '对盲目状态的目标伤害增加25%',
      '触发刺目后概率跟随机一个敌方目标更换一次位置，并让自已在20时序内不可选中为攻击目标',
    ],
    type: 1,
  },
  47: {
    ...
    effect: [
      ...
      '琉璃：自身受到连击伤害会催发内力，恢复受到伤害50%的内力值，用圣火之力分出一个火分身承担伤害，自身则挪移到七格内的安全点，火分身存在10时序且敌人优先攻击火分身（CD30时序最多同时存在一个火分身）',
