...
export default {
  ...
  juHuoLiaoYuan: {
    ...
    effect: ['金乌刀法/燃木刀法/火焰刀法攻击时有50%概率（暴怒必定）触发，追加10时序的“点燃”状态'],
    type: 1,
  },
  shiZunJiangMo: {
    id: 20,
  ...
  liRenHanFeng: {
    ...
    effect: ['修罗刀法/阴风刀法/沧溟刀法攻击时有50%概率、暴怒攻击必定触发，追加10时序的“冻结”状态'],
    type: 1,
  },
  xiaoYaoYuFeng: {
    id: 25,
...
// 加连击率的武功
export const jiaLianJiPeculiar = {
  10: 2.5,
  15: 2.5,
  31: 2.5,
  42: 2.5,
