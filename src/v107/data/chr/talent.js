export default {
  ...
  20: {
    id: 20,
    name: '衡山掌门',
    effect: ['衡山派武学连击率+40%，暴击率+40%，威力+500', '可副运五岳剑诀'],
    fortune: [],
    level: 4,
    score: 45,
  },
  21: {
    id: 21,
    name: '恒山掌门',
    effect: ['恒山派武学连击率+40%，暴击率+40%，威力+500', '可副运五岳剑诀'],
    fortune: [],
    level: 4,
    score: 45,
  },
  ...
  36: {
    id: 36,
    name: '辟邪剑客',
    effect: ['初始集气位置900', '使用辟邪剑法招式无需气', '可使用葵花神功攻击'],
    fortune: [
  ...
  66: {
    id: 66,
    name: '波斯圣女',
    effect: ['敌全体移动减三格', '无视资质学习乾坤大挪移', '可使用圣火神功攻击'],
    fortune: [],
    level: 2,
    score: 15,
  },
  ...
  90: {
    id: 90,
    name: '毓秀灵姝',
    effect: ['攻击时必定造成流血', '使用闪电貂手攻击时概率偷窃敌方携带的物品'],
    fortune: ['天龙正线收段誉，第一格洗为六脉神剑，天赋外功洗为六脉神剑', '到云岭洞找到闪电貂，领悟“灵貂”指令'],
    level: 2,
    score: 10,
  },
  91: {
  ...
  96: {
    id: 96,
    name: '冷月剑',
    effect: ['增加64点防御，被攻击时降低320点气攻，32%概率降低640点气攻'],
    fortune: [],
    level: 2,
    score: 10,
  },
  ...
  149: {
    id: 149,
    name: '千手如来',
    effect: ['使用拳法攻击时，攻击范围增加一格', '可副运易筋神功', '免疫敌方三大吸功的吸内效果'],
    fortune: [],
    level: 4,
    score: 40,
  },
  ...
  500: {
    id: 500,
    name: '剑道巅峰',
    effect: ['高资（资质>79）攻击有15%概率再行动一次，一回合最多触发三次'],
    fortune: [],
    level: 4,
    score: 70,
  },
  ...
  596: {
    id: 596,
    name: '无忧水镜',
    effect: ['非禁疗状态受到致命伤害时，将此次伤害化为自身生命、内力，一场战斗只触发一次'],
    fortune: [],
    level: 4,
    score: 40,
  },
  ...
  611: {
    id: 611,
    name: '幻剑流光',
    effect: ['使用剑法连击伤害不减，且每次连击增加伤害10%', '使用剑法暴击时10%概率追加一次连击'],
    fortune: [],
    level: 3,
    score: 30,
  },
  ...
  626: {
    id: 626,
    name: '小东邪',
    effect: ['特色指令：【玲珑】，可自由切换第一格武功为弹指神通/玉萧剑法/落英神剑掌，不消耗回合'],
    fortune: ['神雕邪峨眉金顶觉醒后，内力变为天罡'],
    level: 3,
    score: 0,
  },
  627: {
  ...
  637: {
    ...
    effect: [
      ...
      '【大道归藏】(畅想专属)：无视条件修炼武功秘籍，所有武功都可以到极',
    ],
    fortune: [],
    level: 4,
    score: 60,
  ...
  638: {
    id: 638,
    name: '九阳至尊',
    effect: ['内力上限9999', '可使用九阳神功攻击', '反震40%伤害'],
    fortune: [],
    level: 3,
    score: 30,
  },
  ...
  681: {
    id: 681,
    name: '天书奇侠',
    effect: ['小虾米每获得一本天书可选择此天书主角的一个天赋、五系成长系数+10、野球拳/九阴白骨爪/西瓜刀法/神山剑法/犽月流空威力+200'],
    fortune: ['小村开启宝箱选择洗第一格武功为野球拳/九阴白骨爪/西瓜刀法/神山剑法/犽月流空之一'],
    level: 4,
    score: 70,
  },
  682: {
  ...
  738: {
    id: 738,
    name: '匪石之心',
    effect: ['牺牲自己的全部生命，救回已经被击败的队友（可选择救谁）'],
    fortune: [],
    level: 1,
    score: 5,
  },
  ...
  9719: {
    id: 9719,
    name: '亢龙破岳',
    effect: ['当前生命越高暴击率越高、暴击伤害越高；击杀目标后五回合伤害+20%'],
    fortune: [],
    level: 4,
    score: 60,
  },
  ...
  9726: {
    id: 9726,
    name: '漠北苟王',
    effect: ['免疫男性连击伤害', '被女性攻击时追加666点伤害'],
    fortune: [],
    level: 4,
    score: 40,
  },
  9727: {
    id: 9727,
    name: '蓑羽凶鹤',
    effect: ['暴怒时攻击附加随机负面状态（不包含控制）', '战斗中首次被击退可复活一次，立即行动'],
    fortune: [],
    level: 2,
    score: 20,
  },
  ...
  9752: {
    id: 9752,
    name: '含沙射影',
    effect: ['6书后暗器攻击范围提升至7×7方阵', '6书后攻击距离越远伤害越高'],
    fortune: [],
    level: 2,
    score: 20,
  },
  ...
  9756: {
    id: 9756,
    name: '袋中乾坤',
    effect: ['攻击敌人时，30%概率使敌人和自己同时获得定乾坤状态，停止行动且免疫一切伤害'],
    fortune: [],
    level: 2,
    score: 10,
  },
  ...
  9794: {
    id: 9794,
    name: '刀剑归真',
    effect: ['苗家剑法或胡家刀法攻击概率触发刀剑归真绝技，必定连击首击出胡刀二击出苗剑绝技，大范围伤害杀气'],
    fortune: [],
    level: 3,
    score: 30,
  },
  ...
  9805: {
    id: 9805,
    name: '定心圆气',
    effect: ['每时序恢复气血/内力/体力，每时序恢复1点冰封/灼烧/流血/中毒'],
    fortune: [],
    level: 2,
    score: 20,
  },
  ...
  9835: {
    id: 9835,
    name: '虎爪绝户',
    effect: ['使用虎爪绝户手触发奥义，对男性造成毁灭性创伤（受自宫惩罚）'],
    fortune: [],
    level: 2,
    score: 10,
  },
  ...
  9846: {
    id: 9846,
    name: '豹胎易筋丸',
    effect: ['在敌方要服用的药品中加入豹胎易筋丸，使其加血效果变为减少加血数值一半的血量'],
    fortune: [],
    level: 2,
    score: 15,
  },
  ...
  9851: {
    id: 9851,
    name: '一气化三清',
    effect: ['40%概率使用武功无消耗，并且将武功消耗的内力转化为怒气值、体力、生命值'],
    fortune: [],
    level: 3,
    score: 30,
  },
  ...
  9876: {
    id: 9876,
    name: '梦幻星辰',
    effect: ['斗转反击时，无视兵器值需求发动离合参商反击并且必连击'],
    fortune: [],
    level: 3,
    score: 30,
  },
  ...
  9925: {
    id: 9925,
    name: '仁者无敌',
    effect: ['特效概率+5并且二次判定', '道德高于100时，免疫暴击、连击伤害'],
    fortune: [],
    level: 4,
    score: 70,
  },
  ...
  9930: {
    id: 9930,
    name: '黑级浮屠',
    effect: ['战场三围属性提升60%', '被攻击时40%概率完全免疫杀气和内伤', '每时序恢复2点中毒'],
    fortune: [],
    level: 4,
    score: 50,
  },
  ...
  9982: {
    id: 9982,
    name: '无我无剑',
    effect: ['被攻击前先手反击，独孤求败先手反击不受攻击距离限制并且有30%概率打断对方攻击'],
    fortune: [],
    level: 4,
    score: 0,
  },
